...
public class RestaurantAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView resName =  view.findViewById(R.id.res_name);
        TextView resAddress =  view.findViewById(R.id.res_address);
        ImageView resLogo =  view.findViewById(R.id.res_logo);
