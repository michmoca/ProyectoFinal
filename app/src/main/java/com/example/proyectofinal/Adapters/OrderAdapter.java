...
import com.example.proyectofinal.Activities.DriverActivity;
import com.example.proyectofinal.Fragments.DeliveryFragment;
import com.example.proyectofinal.Objects.Order;
...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView customerAddress =  view.findViewById(R.id.customer_address);
        ImageView customerImage =  view.findViewById(R.id.customer_image);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("¿Elegir este pedido?");
                builder.setMessage("¿Te gustaría tomar este pedido?");
                builder.setPositiveButton("Cancelar", null);
                builder.setNegativeButton("Sí", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                            Toast.makeText(activity.getApplicationContext(), "PEDIDO TOMADO", Toast.LENGTH_SHORT).show();
        ...
        StringRequest postRequest = new StringRequest
                (Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        // Execute code
                        Log.d("PEDIDO TOMADO", response.toString());

                        try {
                            JSONObject jsonObj = new JSONObject(response);
                            if (jsonObj.getString("status").equals("success")) {
                               FragmentTransaction transaction = ((DriverActivity) activity).getSupportFragmentManager().beginTransaction();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                final SharedPreferences sharedPref = activity.getSharedPreferences("DATOSFB", Context.MODE_PRIVATE);
